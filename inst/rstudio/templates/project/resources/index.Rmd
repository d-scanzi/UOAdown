---
# Thesis details and fron matter
title: 'Why ducks quack and what they are tring to tell us'
author: 'Mr Quack Duck'
date: 'May 2022'
...
# Add your abbreviations here. Although manually might take a while, 
# it does not require to learn any specific LaTex coding, so it should be 
# more accessible. Get rid off these lines if you don't need a glossary. 
abbreviations:
...
# This will automatically install the {remotes} package and {UOAdown}
# Change this to FALSE if you'd like to install them manually on your own.
params:
  'Install needed packages for {UOAdown}': True
output:
  UOAdown::thesis_pdf: default 
#  UOAdown::thesis_gitbook: default         
#  UOAdown::thesis_word: default
#  UOAdown::thesis_epub: default
...
# This chunk ensures that the UOAdown package is
# installed and loaded. This UOAdown package includes
# the template files for the thesis.
if (!require(remotes)) {
  if (params$`Install needed packages for {UOAdown}`) {
